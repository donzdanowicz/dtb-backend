...
public class CurrencyFacade {
    ...
    public void deleteCurrency(final Long id) throws CurrencyNotFoundException {
        CurrencyAud currencyAud = CurrencyAud.builder()
                ...
                .eventType("DELETE")
                .currencyId(id)
                .oldFromCurrency(getCurrency(id).getFromCurrency())
                .oldToCurrency(getCurrency(id).getToCurrency())
    ...
    public void createCurrency(final CurrencyDto currencyDto) throws CurrencyNotFoundException {
        ...
        CurrencyAud currencyAud = CurrencyAud.builder()
                ...
                .newFromCurrency(currencyDto.getFromCurrency())
                .newToCurrency(currencyDto.getToCurrency())
                .newRate(currency.getRate())
